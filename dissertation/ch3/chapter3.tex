...
\section{Fluxo de Funcionamento}
	...
	Um processo de consulta de incidentes (Figura \ref{fig:activityDiagram}) tem inicio no serviço a ser desenvolvido, após a receção de um pedido de pesquisa, é realizada a consulta do incidente na plataforma externa de gestão de incidentes, assim como o histórico de tickets anteriores.
