...
\begin{figure}[H]
	...
	\caption[Detalhes Iniciais do Incidente]{Detalhes Iniciais do Incidente}
...
\caption[Descrição do Incidente]{Decrição do Incidente}
...
\caption[Notas Extra do Incidente]{Notas Extra do Incidente}
...
\caption[Resolução do Incidente]{Resolução do Incidente}
