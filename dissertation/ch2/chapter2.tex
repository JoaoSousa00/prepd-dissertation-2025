...
\section{Revisão de Literatura}
	...
	\subsection{Resultados}
		...
		\subsubsection{Correlação de Incidentes}
			
		
		\subsubsection{Análise de Causa Raiz}
			
		
		\subsubsection{Sugestões de Mitigação e Uso de Incidentes Anteriores}
			
		
		\subsubsection{Apoio à Investigação de Incidentes com LLMs}
