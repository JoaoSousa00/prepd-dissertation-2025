...
\section{Revisão de Literatura}
	...
	\subsection{Correlação de Incidentes}
%		Em paralelo, surgem abordagens orientadas à correlação de incidentes, com o objetivo de identificar relações entre ocorrências aparentemente independentes. O trabalho de Chen et al. (2020), através da ferramenta LiDAR, exemplifica esta linha de investigação ao propor um modelo capaz de ligar incidentes semelhantes, duplicados ou com origem comum. Estes estudos demonstram que a correlação automática de incidentes permite melhorar a priorização, reduzir redundâncias e fornecer contexto adicional relevante para fases posteriores de análise, embora não substitua diretamente o processo de RCA.
		
%		Desde então, surgem abordagens que correlacionam incidentes, com o objetivo de identificar semelhanças entre registos aparentemente distintos. O trabalho de \textcite{Reference3} é um reflexo disso mesmo, propondo um modelo capaz de detetar incidentes semelhantes, duplicados ou com origem comum. Esse estudo aborda problemas como métodos antiquados

% Reference2 --> Segundo o próprio estudo, 36.2\% dos incidentes ocorreram pelo menos 2 vezes, podendo levar à reutilização dos métodos de mitigação.
		\hl{To be continued..}
