...
\section{Conclusão}
	...
	Neste capitulo observamos o planeamento da solução desenvolvida, sendo apresentadas as funcionalidades principais e as integrações externas. Foram ainda abordadas, estatísticas sobre o conjunto de dados que permitem perceber qual a maior área de impacto do serviço. Por fim, apresentam-se requisitos que descrevem as principais funcionalidades e características do sistema a ser desenvolvido e os diagramas que permitem ter uma visão do fluxo de cada análise de incidente.