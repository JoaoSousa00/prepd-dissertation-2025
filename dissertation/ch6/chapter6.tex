...
%----------------------------------------------------------------------------------------
	\subsection{Agentic \gls{SDD}}
		...
		\begin{itemize}
			...
			\item \textbf{Especificação da API} - Descreve as especificações da \textit{API} a ser desenvolvida, definindo os parâmetros de entrada e saída do serviço.
		\end{itemize}
		...
		Após essa definição foram criados os agentes que permitiriam aplicar o processo \textit{SDD} ao desenvolvimento do projeto. Assim, os agentes criados foram:
